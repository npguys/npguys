...
public class CompletedObjectives extends Requirement {
	private String quest;
	private List<Integer> objectives = new ArrayList<Integer>();
	
	public CompletedObjectives(String type) {
		super(type);
	}
	
	@Override 
	public boolean isMet(Conversation context) {
		return ElementManager.getQuestHandler().hasCompletedObjectives(context.getPlayer(), quest, objectives);
	}
	...
	public String getDescription() {
		return "Checks if the player is performing certain quest and has completed certain objectives.";
	}
